...
public class encryption {
    ...
    public static String encrypt(String data, String KEY, String SALT) {
        try {
            ...
            byte[] encryptedDataWithIv = new byte[iv.length +
    ...
    public static String decrypt(
        ...
        try {
            byte[] encryptedDataWithIv = Base64.getDecoder()
            ...
            byte[] encryptedDataWithoutIv =
                new byte[encryptedDataWithIv.length - iv.length];
            System.arraycopy(
                encryptedDataWithIv,
                iv.length,
                encryptedDataWithoutIv,
                0,
                encryptedDataWithoutIv.length
            );
