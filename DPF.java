...
public class DPF {
    ...
    void create(String filename, List<String> dataList, String description, String author, String key, String salt) {
        ...
        String base64Encoded = Base64.getEncoder().encodeToString(metadata.getBytes(StandardCharsets.UTF_8));
        ...
        try {
            ...
            try (FileOutputStream fos = new FileOutputStream(newFile)) {
                ...
                System.out.println("File written in Base64 encoded binary format.");
            }
        } catch (IOException e) {
    ...
    List<String> read(String filename, String key, String salt) {
        ...
        try {
            // Read the .dpf file
            File file = new File(filename + ".dpf");
            ...
            String versionStr = decodedString.split("\"version\": ")[1].split(",")[0];
            String author = decodedString.split("\"author\": \"")[1].split("\"")[0];
            String createdOn = decodedString.split("\"created_on\": \"")[1].split("\"")[0];
            String description = decodedString.split("\"description\": \"")[1].split("\"")[0];
            String encryptedDataString = decodedString.split("\"encrypted_data\": \"")[1].split("\"")[0];
            ...
            System.out.println("An error occurred while processing the file content.");
            e.printStackTrace();
        }
